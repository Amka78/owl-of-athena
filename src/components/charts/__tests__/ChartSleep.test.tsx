...
const sampleSleep: AuroraEvent[] = [
    ...
    { auroraEventId: 2, bins: [], eventAt: sessionStart + 3600000, flags: 1, id: 2, time: 3600000 } as AuroraEvent,
    { auroraEventId: 3, bins: [], eventAt: sessionStart + 7200000, flags: 3, id: 3, time: 7200000 } as AuroraEvent,
    { auroraEventId: 4, bins: [], eventAt: sessionStart + 10800000, flags: 2, id: 4, time: 10800000 } as AuroraEvent,
    { auroraEventId: 5, bins: [], eventAt: sessionStart + 14400000, flags: 4, id: 5, time: 14400000 } as AuroraEvent,
];
...
describe("ChartSleep UnitTest", () => {
    ...
    it("renders without crashing with sleep data", () => {
        expect(() =>
            renderWithProvider(<ChartSleep {...defaultProps} />)
        ).not.toThrow();
    });

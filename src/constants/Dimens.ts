...
export default {
    ...
    session_radial_progress_chart_size_desktop: 90,
    session_radial_progress_chart_size_mobile: 45,
    session_radial_progress_chart_font_size_desktop: 50,
    session_radial_progress_chart_font_size_mobile: 25,
    session_time_text_size_desktop: 30,
    session_time_text_size_mobile: 15,
    session_alarm_meridian_text_size_desktop: 22,
    session_alarm_meridian_text_size_mobile: 11,
    session_percent_label_size_desktop: 15,
    session_percent_label_size_mobile: 6,
    session_category_label_size_desktop: 20,
    session_category_label_size_mobile: 12,
    session_chart_pie_outer_radius_desktop: 146,
    session_chart_pie_outer_radius_mobile: 63,
    session_chart_pie_inner_radius_desktop: 80,

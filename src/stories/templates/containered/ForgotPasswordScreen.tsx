...
import {
    ...
    type ForgotPasswordScreenTemplateProps,
...
//#region Types
export type ForgotPasswordScreenProps = Omit<ForgotPasswordScreenTemplateProps, "dimens">;
//#endregion
...
export const ForgotPasswordScreen: FunctionComponent<ForgotPasswordScreenProps> = (
    ...
    return (
        <Container dimens={dimens}>
            <ForgotPasswordScreenTemplate {...props} dimens={dimens}></ForgotPasswordScreenTemplate>
        </Container>
    );
};
//#endregion
